...
openApiValidate {
    inputSpec.set("$projectDir/../balionis-wise-mcs-api/src/main/resources/openapi/balionis-wise-mcs-api.yaml")
}
...
openApiGenerate {
    ...
    apiPackage.set("com.balionis.wise.mcs.generated.api")
    modelPackage.set("com.balionis.wise.mcs.generated.model")
...
tasks.jacocoTestCoverageVerification {
    violationRules {
        rule {
            ...
            excludes = listOf(
                "com.balionis.wise.mcs.Application",
                "com.balionis.wise.mcs.configuration.*",
                "com.balionis.wise.mcs.generated.*"
            )
        }
    }
...
tasks.named<BootJar>("bootJar") {
    mainClass.set("com.balionis.wise.mcs.Application")
